...
def convert_investidor10_data(data):
    ...
    return {
        ...
        'latests_dividends': text_to_number(get_substring(get_substring(data, 'YIELD 12 MESES', '<div class="content--info--item">', patterns_to_remove), 'content--info--item--value amount">', '</span>')),
