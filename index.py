...
def convert_investidor10_data(data):
    ...
    return {
        ...
        'latests_dividends': text_to_number(get_substring(get_substring(data, 'YIELD 12 MESES', '</div>'), 'amount">', '</span>', patterns_to_remove)),
        'latest_dividend': text_to_number(get_substring(data, 'ÚLTIMO RENDIMENTO', '</div>', patterns_to_remove)),
        'ffoy': None,
